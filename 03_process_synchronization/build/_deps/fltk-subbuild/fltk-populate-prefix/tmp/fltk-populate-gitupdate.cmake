...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "release-1.4.4"
  WORKING_DIRECTORY "/Users/bytedance/GitRepos/os-course-design/03_process_synchronization/build/_deps/fltk-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "release-1.4.4")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("release-1.4.4" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: release-1.4.4")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/release-1.4.4")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"release-1.4.4\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/bytedance/GitRepos/os-course-design/03_process_synchronization/build/_deps/fltk-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/bytedance/GitRepos/os-course-design/03_process_synchronization/build/_deps/fltk-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
